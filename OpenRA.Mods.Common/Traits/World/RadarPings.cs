...
namespace OpenRA.Mods.Common.Traits
{
	...
	public class RadarPings : ITick
	{
		...
		// Stage B (DecoupledRendering): the sim thread ticks/adds/removes pings while the main thread's
		...
		// Stage B: written by the sim thread (Add) and read by the main thread (jump-to-last-event hotkey).
