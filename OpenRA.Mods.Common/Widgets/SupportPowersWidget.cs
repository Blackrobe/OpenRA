...
namespace OpenRA.Mods.Common.Widgets
{
	public class SupportPowersWidget : Widget
	{
		...
		public class SupportPowerIcon
		{
			...
			// Stage B (DecoupledRendering): IconOverlayTextOverride() is virtual; the C&C charge-drain override
			...
			// Stage B (DecoupledRendering): the support-power tooltip (SupportPowerTooltipLogic) runs during the
		...
		{
			// Stage B (DecoupledRendering): Target() sets up an order generator from live power/world state - wait
		...
		{
			// Stage B (DecoupledRendering): RefreshIcons enumerates the live, sim-mutated Powers dictionary.
			...
			try
			{
				...
				// Stage B (DecoupledRendering): re-resolve from the live cursor position every tick (not just on
