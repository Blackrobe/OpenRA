...
namespace OpenRA.Mods.Common.Widgets
{
	public class ObserverProductionIconsWidget : Widget
	{
		...
		// Stage B (DecoupledRendering): the live production state (CurrentItem/AllItems enumerations, icon-overlay
		...
		public override void Draw()
		{
			...
			for (var iconIdx = 0; iconIdx < productionIcons.Count; iconIdx++)
			{
				...
				// Stage B (DecoupledRendering): RemainingTimeActual is virtual and the parallel-queue overrides
