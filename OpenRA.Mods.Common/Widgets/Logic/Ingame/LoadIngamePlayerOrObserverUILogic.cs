...
namespace OpenRA.Mods.Common.Widgets.Logic
{
	public class LoadIngamePlayerOrObserverUILogic : ChromeLogic
	{
		...
		public LoadIngamePlayerOrObserverUILogic(Widget widget, World world)
		{
			...
			world.GameOver += () =>
			{
				// Stage B (E-07): World.GameOver fires from World.EndGame during the sim tick, but this body mutates the
				...
				void OnGameOver()
				{
					// E-07: besides the widget mutations (main-thread, via the marshal), this reads LIVE world state
