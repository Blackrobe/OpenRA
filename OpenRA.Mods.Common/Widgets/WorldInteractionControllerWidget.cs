...
namespace OpenRA.Mods.Common.Widgets
{
	public class WorldInteractionControllerWidget : Widget
	{
		...
		public override bool HandleMouseInput(MouseInput mi)
		{
			...
			// Stage B (DecoupledRendering): the whole mouse-input decision reads live world state and dispatches
		...
		{
			// Stage B (DecoupledRendering): GetCursor runs every frame from unlocked cursor rendering and dispatches
