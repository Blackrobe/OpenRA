...
namespace OpenRA.Mods.Common.Widgets
{
	public sealed class RadarWidget : Widget, IDisposable
	{
		...
		public override string GetCursor(int2 pos)
		{
			...
			// Stage B (DecoupledRendering): OrderGenerator.GetCursor dispatches the virtual generator, which reads
		...
		public override bool HandleMouseInput(MouseInput mi)
		{
			...
			// Stage B (DecoupledRendering): this reads world.OrderGenerator and forwards a synthetic click into the
		...
		public override void Tick()
		{
			...
			// Stage B (DecoupledRendering): PopulateRadarSignatureCells runs trait code over live actor state, so
