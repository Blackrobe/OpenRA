...
namespace OpenRA.Mods.Common.Widgets
{
	...
	public class ProductionTabsWidget : Widget
	{
		...
		// Stage B (DecoupledRendering): world.ActorAdded/ActorRemoved fire on the SIM thread (actor spawn/death
		...
		public override void Tick()
		{
			...
			// Stage B (DecoupledRendering): inspect/refresh queue state only when the sim thread is not mid-tick,
		...
		public override bool HandleMouseInput(MouseInput mi)
		{
			...
			{
				// Stage B: switching the queue refreshes the palette's icons from live queue state - wait out any
