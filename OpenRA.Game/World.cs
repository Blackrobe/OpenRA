...
namespace OpenRA
{
	...
	public sealed class World : IDisposable
	{
		...
		// Stage B (DecoupledRendering): actors are added/removed on the sim thread while the main thread can
		...
		// Stage B (DecoupledRendering): the sim thread drains frameEndActions at the end of each World.Tick, while
		...
		//
		// Stage B (DecoupledRendering): this MUST be thread-local. The main thread sets it true while rendering AT
