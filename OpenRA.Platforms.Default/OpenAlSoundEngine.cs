...
namespace OpenRA.Platforms.Default
{
	sealed class OpenAlSoundEngine : ISoundEngine
	{
		...
		// Stage B (DecoupledRendering): World.Tick now runs on the sim thread, so trait/warhead Sound.Play* calls
		...
		{
			// Stage B: the find-and-claim must be atomic - sim-thread and main-thread Sound.Play* both pull here.
			lock (poolSync)
			{
